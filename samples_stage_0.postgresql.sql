...
VALUES
    ...
    ('Good Omens', NULL, (SELECT id FROM language WHERE iso_639_1_language_code = 'en'), '1990-05-01'),
    ('The Talisman', NULL, (SELECT id FROM language WHERE iso_639_1_language_code = 'en'), '1984-11-08'),
    ('The Relic', NULL, (SELECT id FROM language WHERE iso_639_1_language_code = 'en'), '1995-01-15');
...
VALUES
    ...
    ('Territories, as every male animal knows, are secured by shitting on them. That''s the way it worked in the Oligocene, and thats the way it works in the condominium association.');

INSERT INTO quote (source_id, content_id)
SELECT
    s.id AS source_id,
    c.id AS content_id
FROM
...
INNER JOIN
    content c ON c.id = (
        CASE s.title
            ...
            WHEN 'Good Omens' THEN 50
            WHEN 'The Talisman' THEN 51
            WHEN 'The Relic' THEN 52
        END
    );

INSERT INTO quote_author (quote_id, author_id)
VALUES
    ((SELECT id FROM quote WHERE content_id = 1), (SELECT id FROM author WHERE penname = 'F. Scott Fitzgerald')),
    ((SELECT id FROM quote WHERE content_id = 2), (SELECT id FROM author WHERE penname = 'Gabriel García Márquez')),
    ((SELECT id FROM quote WHERE content_id = 3), (SELECT id FROM author WHERE penname = 'J.D. Salinger')),
    ((SELECT id FROM quote WHERE content_id = 4), (SELECT id FROM author WHERE penname = 'Harper Lee')),
    ((SELECT id FROM quote WHERE content_id = 5), (SELECT id FROM author WHERE penname = 'George Orwell')),
    ((SELECT id FROM quote WHERE content_id = 6), (SELECT id FROM author WHERE penname = 'Jane Austen')),
    ((SELECT id FROM quote WHERE content_id = 7), (SELECT id FROM author WHERE penname = 'J.R.R. Tolkien')),
    ((SELECT id FROM quote WHERE content_id = 8), (SELECT id FROM author WHERE penname = 'Aldous Huxley')),
    ((SELECT id FROM quote WHERE content_id = 9), (SELECT id FROM author WHERE penname = 'Anne Frank')),
    ((SELECT id FROM quote WHERE content_id = 10), (SELECT id FROM author WHERE penname = 'Antoine de Saint-Exupéry')),
    ((SELECT id FROM quote WHERE content_id = 11), (SELECT id FROM author WHERE penname = 'Miguel de Cervantes')),
    ((SELECT id FROM quote WHERE content_id = 12), (SELECT id FROM author WHERE penname = 'Herman Melville')),
    ((SELECT id FROM quote WHERE content_id = 13), (SELECT id FROM author WHERE penname = 'Leo Tolstoy')),
    ((SELECT id FROM quote WHERE content_id = 14), (SELECT id FROM author WHERE penname = 'William Shakespeare')),
    ((SELECT id FROM quote WHERE content_id = 15), (SELECT id FROM author WHERE penname = 'Homer')),
    ((SELECT id FROM quote WHERE content_id = 16), (SELECT id FROM author WHERE penname = 'Gustave Flaubert')),
    ((SELECT id FROM quote WHERE content_id = 17), (SELECT id FROM author WHERE penname = 'Dante Alighieri')),
    ((SELECT id FROM quote WHERE content_id = 18), (SELECT id FROM author WHERE penname = 'Vladimir Nabokov')),
    ((SELECT id FROM quote WHERE content_id = 19), (SELECT id FROM author WHERE penname = 'Fyodor Dostoevsky')),
    ((SELECT id FROM quote WHERE content_id = 20), (SELECT id FROM author WHERE penname = 'Fyodor Dostoevsky')),
    ((SELECT id FROM quote WHERE content_id = 21), (SELECT id FROM author WHERE penname = 'Emily Brontë')),
    ((SELECT id FROM quote WHERE content_id = 22), (SELECT id FROM author WHERE penname = 'Albert Camus')),
    ((SELECT id FROM quote WHERE content_id = 23), (SELECT id FROM author WHERE penname = 'Franz Kafka')),
    ((SELECT id FROM quote WHERE content_id = 24), (SELECT id FROM author WHERE penname = 'James Joyce')),
    ((SELECT id FROM quote WHERE content_id = 25), (SELECT id FROM author WHERE penname = 'Franz Kafka')),
    ((SELECT id FROM quote WHERE content_id = 26), (SELECT id FROM author WHERE penname = 'John Steinbeck')),
    ((SELECT id FROM quote WHERE content_id = 27), (SELECT id FROM author WHERE penname = 'Leo Tolstoy')),
    ((SELECT id FROM quote WHERE content_id = 28), (SELECT id FROM author WHERE penname = 'Joseph Conrad')),
    ((SELECT id FROM quote WHERE content_id = 29), (SELECT id FROM author WHERE penname = 'Ernest Hemingway')),
    ((SELECT id FROM quote WHERE content_id = 30), (SELECT id FROM author WHERE penname = 'Alexandre Dumas')),
    ((SELECT id FROM quote WHERE content_id = 31), (SELECT id FROM author WHERE penname = 'Oscar Wilde')),
    ((SELECT id FROM quote WHERE content_id = 32), (SELECT id FROM author WHERE penname = 'Charlotte Brontë')),
    ((SELECT id FROM quote WHERE content_id = 33), (SELECT id FROM author WHERE penname = 'Homer')),
    ((SELECT id FROM quote WHERE content_id = 34), (SELECT id FROM author WHERE penname = 'Victor Hugo')),
    ((SELECT id FROM quote WHERE content_id = 35), (SELECT id FROM author WHERE penname = 'Mary Shelley')),
    ((SELECT id FROM quote WHERE content_id = 36), (SELECT id FROM author WHERE penname = 'Paulo Coelho')),
    ((SELECT id FROM quote WHERE content_id = 37), (SELECT id FROM author WHERE penname = 'Ken Kesey')),
    ((SELECT id FROM quote WHERE content_id = 38), (SELECT id FROM author WHERE penname = 'Charles Dickens')),
    ((SELECT id FROM quote WHERE content_id = 39), (SELECT id FROM author WHERE penname = 'Mikhail Bulgakov')),
    ((SELECT id FROM quote WHERE content_id = 40), (SELECT id FROM author WHERE penname = 'Douglas Adams')),
    ((SELECT id FROM quote WHERE content_id = 41), (SELECT id FROM author WHERE penname = 'J.R.R. Tolkien')),
    ((SELECT id FROM quote WHERE content_id = 42), (SELECT id FROM author WHERE penname = 'Ray Bradbury')),
    ((SELECT id FROM quote WHERE content_id = 43), (SELECT id FROM author WHERE penname = 'Hans Christian Andersen')),
    ((SELECT id FROM quote WHERE content_id = 44), (SELECT id FROM author WHERE penname = 'Lewis Carroll')),
    ((SELECT id FROM quote WHERE content_id = 45), (SELECT id FROM author WHERE penname = 'Umberto Eco')),
    ((SELECT id FROM quote WHERE content_id = 46), (SELECT id FROM author WHERE penname = 'Haruki Murakami')),
    ((SELECT id FROM quote WHERE content_id = 47), (SELECT id FROM author WHERE penname = 'Milan Kundera')),
    ((SELECT id FROM quote WHERE content_id = 48), (SELECT id FROM author WHERE penname = 'Murasaki Shikibu')),
    ((SELECT id FROM quote WHERE content_id = 49), (SELECT id FROM author WHERE penname = 'Margaret Atwood')),
    ((SELECT id FROM quote WHERE content_id = 50),  (SELECT id FROM author WHERE penname = 'Neil Gaiman')),
    ((SELECT id FROM quote WHERE content_id = 50), (SELECT id FROM author WHERE penname = 'Terry Pratchett')),
    ((SELECT id FROM quote WHERE content_id = 51), (SELECT id FROM author WHERE penname = 'Stephen King')),
    ((SELECT id FROM quote WHERE content_id = 51), (SELECT id FROM author WHERE penname = 'Peter Straub')),
    ((SELECT id FROM quote WHERE content_id = 52), (SELECT id FROM author WHERE penname = 'Douglas Preston')),
    ((SELECT id FROM quote WHERE content_id = 52), (SELECT id FROM author WHERE penname = 'Lincoln Child'));